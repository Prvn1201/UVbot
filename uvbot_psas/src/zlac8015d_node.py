...
class MotorDriverNode:
	...
	def zlac8015d_vel_cmd_callback(self, msg):
		self.left_vel_cmd = msg.linear.x
		self.right_vel_cmd = -msg.linear.x
	...
	def zlac8015d_rpm_cmd_callback(self, msg):
		self.left_rpm_cmd = msg.linear.x
		self.right_rpm_cmd = -msg.linear.x
	...
	def zlac8015d_deg_cmd_callback(self, msg):
		self.left_pos_deg_cmd = msg.angular.z
		self.right_pos_deg_cmd = -msg.angular.z
	...
	def zlac8015d_dist_cmd_callback(self, msg):
		self.left_pos_dist_cmd = msg.angular.z
		self.right_pos_dist_cmd = msg.angular.z
